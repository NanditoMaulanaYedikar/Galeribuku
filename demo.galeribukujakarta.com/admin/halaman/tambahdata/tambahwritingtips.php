    ...
    if (@$_POST['simpan']){
        ...
        if (!empty($gambar) && is_uploaded_file($tmp)) {
            ...
            if (move_uploaded_file($tmp, "../img/$nama_gambar_baru")) {
                ...
                $query = mysqli_query($k, "INSERT INTO tb_writingtips(judul, sinopsis, penjelasan, gambar, deskripsi, tanggal, penulis, sponsor) VALUES( '$judul', '$sinopsis','$isi','$nama_gambar_baru', '$deskripsi', '$tanggal', '$penulis', '$sponsor')");
