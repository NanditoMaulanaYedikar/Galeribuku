...
include "koneksi.php";
?>
<h3 class="mt-4">Form most populer</h3>
<hr>
<style>
    .bold-button {
        padding: 5px 10px;
...
<form method="post" action="" enctype="multipart/form-data">
    <div class="row mb-3">
        <div class="col-md-12">
            <select class="form-control" name="txtjenis" id="" placeholder="Masukkan Jenis Artikel">
                <option value="Kata & Kota">Kata & Kota</option>
                <option value="Fiksi & Puisi">Fiksi & Puisi</option>
                <option value="Buku">Buku</option>
                <option value="Pemikiran">Pemikiran</option>
                <option value="Coffeesophia">Coffeesophia</option>
                <option value="Writing Tips">Writing Tips</option>
                <option value="Inspirasi">Inspirasi</option>
                <option value="Gairah">Gairah</option>
    ...
    if (@$_POST['simpan']){
        ...
        if (!empty($gambar) && is_uploaded_file($tmp)) {
            ...
            if (move_uploaded_file($tmp, "../img/$nama_gambar_baru")) {
                ...
                $query = mysqli_query($k, "INSERT INTO tb_mostpopular(jenisrubrik, judul, sinopsis, penjelasan, gambar, deskripsi, tanggal, penulis, sponsor) VALUES('$jenis', '$judul', '$sinopsis','$isi','$nama_gambar_baru', '$deskripsi', '$tanggal', '$penulis', '$sponsor')");
