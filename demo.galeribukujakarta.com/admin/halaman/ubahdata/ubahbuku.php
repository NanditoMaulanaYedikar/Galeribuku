<?php
    include "koneksi.php";
    $id = $_GET['id'];
    $sql = "SELECT * FROM tb_buku WHERE no_buku = '$id'";
...
<form method="post" action="" enctype="multipart/form-data">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <div class="form-floating mb-3 mb-md-0">
                <input  name ="txtdurasi" value="<?=$r['durasi']?>" class="form-control" type="text" placeholder="Masukkan Perkiraan Durasi" />
    ...
    if (@$_POST['simpan']) {
        ...
        if (empty($gambar)) {
            $query = "UPDATE tb_buku SET deskripsi='$deskripsi', judul='$judul', sinopsis='$sinopsis', penjelasan='$isi', durasi='$durasi', penulis='$penulis', tanggal='$datetime', sponsor='$sponsor' WHERE no_buku='$id'";
        } else {
            if (move_uploaded_file($tmp, "../img/$nama_gambar_baru")) {
                $query = "UPDATE tb_buku SET gambar='$nama_gambar_baru', deskripsi='$deskripsi', judul='$judul', sinopsis='$sinopsis', penjelasan='$isi', durasi='$durasi', penulis='$penulis', tanggal='$datetime', sponsor='$sponsor' WHERE no_buku='$id'";
            } else {
