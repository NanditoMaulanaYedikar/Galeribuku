...
$query_head = "SELECT * FROM tb_inspirasi ORDER BY no_inspirasi DESC LIMIT 4";
$result_head = mysqli_query($k, $query_head);

$query_body = "SELECT * FROM tb_inspirasi ORDER BY no_inspirasi DESC LIMIT 4 OFFSET 4";
            ...
            <div class="desc">
                <ul>
                    ...
                    while ($row_head = mysqli_fetch_assoc($result_head)) {
                        echo '<li>
                                <h3>Inspirasi</h3>
                                <p><a href="?page=inspirasi-detail&no_inspirasi=' . $row_head['no_inspirasi'] . '">' . $row_head['judul'] . '</a></p>
                            </li>';
                    }
                    ?>
                </ul>
                    ...
                    <div class="artikel">
                        ...
                        while ($row_body = mysqli_fetch_assoc($result_body)) {
                            echo '<div class="content border">
                                    <div class="desc">
                                        <h1>Inspirasi</h1>
                                        <h3><a href="?page=inspirasi-detail&no_inspirasi=' . $row_body['no_inspirasi'] . '">' . $row_body['judul'] . '</a></h3>
                                        <p><a href="?page=inspirasi-detail&no_inspirasi=' . $row_body['no_inspirasi'] . '">' . $row_body['penjelasan'] . '</a></p>
                                    </div>
