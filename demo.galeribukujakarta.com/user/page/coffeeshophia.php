...
$query_head = "SELECT * FROM tb_coffeesophia ORDER BY no_coffeesophia DESC LIMIT 4";
$result_head = mysqli_query($k, $query_head);

$query_body = "SELECT * FROM tb_coffeesophia ORDER BY no_coffeesophia DESC LIMIT 4 OFFSET 4";
            ...
            <div class="desc">
                <ul>
                    ...
                    while ($row_head = mysqli_fetch_assoc($result_head)) {
                        echo '<li>
                                <h3>coffeeshophia</h3>
                                <p><a href="?page=coffeesophia-detail&no_coffeesophia=' . $row_head['no_coffeesophia'] . '">' . $row_head['judul'] . '</a></p>
                            </li>';
                    }
                    ?>
                </ul>
                    ...
                    <div class="artikel">
                        ...
                        while ($row_body = mysqli_fetch_assoc($result_body)) {
                            echo '<div class="content border">
                                    <div class="desc">
                                        <h1>Coffeeshophia</h1>
                                        <h3><a href="?page=coffeesophia-detail&no_coffeesophia=' . $row_body['no_coffeesophia'] . '">' . $row_body['judul'] . '</a></h3>
                                        <p><a href="?page=coffeesophia-detail&no_coffeesophia=' . $row_body['no_coffeesophia'] . '">' . $row_body['penjelasan'] . '</a></p>
                                    </div>
