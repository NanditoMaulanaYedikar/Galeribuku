...
$query_head = "SELECT * FROM tb_writingtips ORDER BY no_writingtips DESC LIMIT 4";
$result_head = mysqli_query($k, $query_head);

$query_body = "SELECT * FROM tb_writingtips ORDER BY no_writingtips DESC LIMIT 4 OFFSET 4";
            ...
            <div class="desc">
                <ul>
                    ...
                    while ($row_head = mysqli_fetch_assoc($result_head)) {
                        echo '<li>
                                <h3>Writing Tips</h3>
                                <p><a href="?page=writingtips-detail&no_writingtips=' . $row_head['no_writingtips'] . '">' . $row_head['kutipan'] . '</a></p>
                            </li>';
                    }
                    ?>
                </ul>
                    ...
                    <div class="artikel">
                        ...
                        while ($row_body = mysqli_fetch_assoc($result_body)) {
                            echo '<div class="content border">
                                    <div class="desc">
                                        <h1>Writing Tips</h1>
                                        <h3><a href="?page=writingtips-detail&no_writingtips=' . $row_body['no_writingtips'] . '">' . $row_body['kutipan'] . '</a></h3>
                                        <p><a href="?page=writingtips-detail&no_writingtips=' . $row_body['no_writingtips'] . '">' . $row_body['penjelasan'] . '</a></p>
                                    </div>
