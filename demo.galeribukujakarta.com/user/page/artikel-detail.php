...
<section id="artikel2">
    ...
    <?php
        ...
        $sql_select = "SELECT jumlah_dilihat FROM tb_artikel WHERE no_artikel = '$id1'";
        ...
        if ($result) {
            ...
            $sql_update = "UPDATE tb_artikel SET jumlah_dilihat = $new_views WHERE no_artikel = '$id1'";
            mysqli_query($k, $sql_update);
        }

        $sql1 = "SELECT * FROM tb_artikel WHERE no_artikel='$id1' ORDER BY no_artikel DESC LIMIT 1";
    ...
    <div class="header">
        <h2>artikel</h2>
        <h1><?= htmlspecialchars($r1['judul_artikel'], ENT_QUOTES, 'UTF-8') ?></h1>
    ...
    <div class="meta-wrapper">
        <div class="article-meta"><?= htmlspecialchars($r1['tanggal_terbit'], ENT_QUOTES, 'UTF-8') ?></div>
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <p><?php
                $penjelasan = nl2br(htmlspecialchars_decode($r1['penjelasan_artikel']));
                echo $penjelasan;
            ?></p>                    
        </div>
    </div>
